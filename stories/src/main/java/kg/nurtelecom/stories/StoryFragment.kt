...
import kg.nurtelecom.stories.databinding.ViewStoryBinding
...
import kg.nurtelecom.stories.views.GesturesListener
...
class StoryFragment : Fragment(), ProgressBarListener, GesturesListener {
    ...
    private lateinit var vb: ViewStoryBinding
    ...
    override fun onCreateView(
        ...
        vb = ViewStoryBinding.inflate(layoutInflater)
        return vb.root
    }
    ...
    private fun setViewsByDetailedStory(index: Int) {
        detailedStories[index].let { story ->
            ...
            setTextGradient()
            context?.let {
                changeForeground(ContextCompat.getDrawable(it, R.drawable.bg_shading)) }
    ...
    private fun showDescription() = with(vb) {
        ...
        context?.let {
            changeForeground(ContextCompat.getDrawable(it, R.drawable.bg_semi_transparent)) }
    ...
    private fun setTextGradient() {
        val gradient = context?.let {
            LinearGradient(
                ...
                it.getColor(com.design2.chili2.R.color.white_1),
                it.getColor(com.design2.chili2.R.color.white_alpha_0),
    ...
    private fun setupViewByStory() {
        if (story?.isMarketingCenter == true) {
            ...
            vb.flCardView.setBackgroundResource(R.drawable.story_border)
        }
    }
