...
class StoryProgressBar @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet,
    defStyleAttr: Int = com.design2.chili2.R.attr.progressCellViewDefaultStyle,
    defStyleRes: Int = com.design2.chili2.R.style.Chili_CellViewStyle_ProgressCellView
) : LinearLayout(context, attrs, defStyleAttr, defStyleRes), ProgressListener {

    private val animatedProgressLines = mutableListOf<StoryProgressLine>()
    ...
    private fun obtainAttributes(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        context.obtainStyledAttributes(attrs,
            R.styleable.StoryProgressBar, defStyleAttr, defStyleRes).run {
    ...
    private fun getProgressLine() =
        StoryProgressLine(context).apply {
